...
const MapSection = () => {
	...
	return (
		<section
			...
			id='map'
		>
			<div className='relative flex w-full flex-col pt-16 justify-start gap-1 bg-panel p-10 pl-8 text-copy lg:w-1/2 lg:pl-20'>
				<h3 className='mb-2 text-4xl font-bold'>Краеведа Соловьёва</h3>
				<p className='mb-4 text-md text-copy/60'>
					Краснодар, ул. Краеведа Соловьёва 6, к. 3
				</p>
				<p className='text-2xl font-bold hover:text-accent'>
					<FaPhoneAlt className='mr-2 inline' size={14} />
					<a href='tel:+79615177332'>+7 (961) 517-73-32</a>
				</p>
				<p className='text-[19px] hover:text-accent'>
					<IoMdMailOpen className='group mr-1.5 inline' size={17} />
					<a
						href='mailto:thrill@gmail.com'
						className='text-copy/80 '
					>
						thrill@gmail.com
					</a>
				</p>
			...
			<div className='relative h-100! w-full overflow-hidden bg-panel lg:h-auto lg:w-2/3'>
